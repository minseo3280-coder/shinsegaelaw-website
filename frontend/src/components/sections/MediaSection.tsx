  ...
  return (
    <section id="media" className="py-12 md:py-28 bg-[#F8F4EE]">
      <div className="max-w-[1400px] mx-auto px-5 md:px-8 lg:px-10">
        {/* Section header */}
        <ScrollReveal>
          <p className="text-[15px] md:text-[15px] text-gold-500 tracking-[0.3em] uppercase mb-2">News &amp; Media</p>
              ...
              {recentNews.map((item) => (
                ...
                >
                  <div className="flex-1">
                    <p className="text-[14px] text-burgundy-500 font-semibold mb-1">{item.category || "언론보도"}</p>
                    ...
                    <p className="text-[14px] md:text-[15px] text-[#333333] mt-1.5 md:mt-2">{item.year || item.date}</p>
                  </div>

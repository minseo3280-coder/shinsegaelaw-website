  ...
  return (
    <>
      <div className="relative h-[180px] md:h-[300px] overflow-hidden">
        ...
        {/* Content */}
        <div className="relative z-10 max-w-[1400px] mx-auto px-5 md:px-8 lg:px-10 h-full flex flex-col justify-end pb-6 md:pb-10">
          {/* Breadcrumb */}
          <nav className="flex items-center gap-2 text-[15px] md:text-[15px] text-white/55 mb-2 md:mb-4">
          ...
          {titleEn && (
            <p className="text-[14px] md:text-[16px] tracking-[0.3em] text-white/65 font-semibold uppercase mb-2 md:mb-3">
              {titleEn}
            </p>
          )}

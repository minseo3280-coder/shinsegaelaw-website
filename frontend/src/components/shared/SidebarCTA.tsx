  ...
  return (
    <div className="rounded-[16px] overflow-hidden bg-[#0f0f1a] p-6 text-center relative">
      ...
      <div className="relative z-10">
        <p className="text-[10px] tracking-[0.2em] text-gold-500/50 uppercase mb-2">
          Consultation
        </p>
        ...
        <Link
          href="/consultation"
          className="block w-full py-[10px] rounded-full bg-gold-500 hover:bg-gold-400 text-[#0f0f1a] text-[12px] font-bold transition-all duration-300 text-center hover:shadow-[0_0_20px_rgba(201,168,76,0.15)]"
        >
          상담 신청하기
        </Link>
      </div>
